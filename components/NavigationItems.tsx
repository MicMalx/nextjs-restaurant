...
export function NavigationItems() {
    ...
    return (
        <nav className='py-5 flex flex-wrap items-center justify-between'>
            ...
            >
                <span className={clsx('block w-[25px] h-[3px] rounded my-[5px] mx-auto bg-white transition-all ease-in-out duration-300 delay-0', { 'translate-y-[8px] rotate-45': showMobileNav })}></span>
                <span className={clsx('block w-[25px] h-[3px] rounded my-[5px] mx-auto bg-white transition-all ease-in-out duration-300 delay-0', { 'opacity-0': showMobileNav })}></span>
                <span className={clsx('block w-[25px] h-[3px] rounded my-[5px] mx-auto bg-white transition-all ease-in-out duration-300 delay-0', { 'translate-y-[-8px] -rotate-45': showMobileNav })}></span>
            </div>
            <ul className={clsx(
